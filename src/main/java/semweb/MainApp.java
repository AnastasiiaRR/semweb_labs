...
public class MainApp {
    ...
    static String PERSON_URI = "https://github.com/AnastasiiaRR/semweb_labs";
    static String FULL_NAME = "Revunets Anastasiia";
    static String GIVEN_NAME = "Anastasiia";
    static String FAMILY_NAME = "Revunets ";
